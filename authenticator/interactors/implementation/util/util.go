...
// PasswordManager represents the min length of a password
...
// UserNotFoundMessage is the text of the error message when a user is not found
...
// UserNotFoundError is the result error when a user is not found
