...
import (
	...
	"github.com/bixlabs/authentication/api/healthcheck"
	"github.com/bixlabs/authentication/api/usermanager"
...
func main() {
	...
	userManager := implementation.NewUserManager(authOperations, userRepo)
	authentication.NewAuthenticatorRESTConfigurator(authOperations, passwordManager, router)
	usermanager.NewUserManagerRESTConfigurator(userManager, router)
	healthcheck.NewHealthCheckRESTConfigurator(userRepo, sender, authOperations, passwordManager, router)
